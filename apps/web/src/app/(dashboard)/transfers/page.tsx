  ...
  return (
    <div className="flex animate-fade-in-up flex-col gap-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-stone-900 dark:text-stone-50">Transfers</h1>
          <p className="text-sm text-stone-500">Inter-branch / central-kitchen stock transfers — PRD §3.10</p>
        </div>
