...
export default async function SuppliersPage() {
  ...
  return (
    <div className="flex animate-fade-in-up flex-col gap-6">
      <div>
        <h1 className="text-2xl font-bold tracking-tight text-stone-900 dark:text-stone-50">Suppliers</h1>
        <p className="text-sm text-stone-500 dark:text-stone-400">Supplier master &amp; pricing — PRD §3.2</p>
      </div>
