  ...
  return (
    <div className="flex animate-fade-in-up flex-col gap-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-2xl font-semibold text-stone-900 dark:text-stone-50">Purchase orders</h1>
          <p className="text-sm text-stone-500">Procurement workflow — PRD §3.3</p>
        </div>
